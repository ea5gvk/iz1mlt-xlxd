...
#define TRANSCODER_AMBEPACKET_TIMEOUT   1000                                // in ms
...
#define DMRIDDB_PATH                    "/var/log/xlxd/dmrid.dat"                   // local file path
...
#define YSFNODEDB_PATH                  "/var/log/xlxd/ysfnode.dat"                 // local file path
